...
set output "html/WCB/RAS_GLB_thumb.png"

plot 	"html/WCB/RAS_GLB_terrain.dat" using 1:2 with lines title "Elevation Profile" lt rgb "#006400", 	"html/WCB/RAS_GLB_fresnel.dat" using 1:2 with lines title "First Fresnel Zone" lc rgb "#FF7F50" lt 2, 	"html/WCB/RAS_GLB_fresnel.dat" using 3:4 with lines notitle lc rgb "#FF7F50" lt 2, 	"html/WCB/RAS_GLB_ptp.dat" using 1:2 with lines title "Direct path" lt rgb "#8A2BE2"

set title "Point to Point link: RAS -> GLB"
...
set output "html/WCB/RAS_GLB.png"
replot

set notitle
set terminal epslatex color size 5.75,6
set output "html/WCB/RAS_GLB.tex"
replot
