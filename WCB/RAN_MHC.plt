...
set output "html/WCB/RAN_MHC_thumb.png"

plot 	"html/WCB/RAN_MHC_terrain.dat" using 1:2 with lines title "Elevation Profile" lt rgb "#006400", 	"html/WCB/RAN_MHC_fresnel.dat" using 1:2 with lines title "First Fresnel Zone" lc rgb "#FF7F50" lt 2, 	"html/WCB/RAN_MHC_fresnel.dat" using 3:4 with lines notitle lc rgb "#FF7F50" lt 2, 	"html/WCB/RAN_MHC_ptp.dat" using 1:2 with lines title "Direct path" lt rgb "#8A2BE2"

set title "Point to Point link: RAN -> MHC"
...
set output "html/WCB/RAN_MHC.png"
replot

set notitle
set terminal epslatex color size 5.75,6
set output "html/WCB/RAN_MHC.tex"
replot
